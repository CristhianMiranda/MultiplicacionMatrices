...
import org.proyecto.multiplicacionmatrices.algoritmosimplementacion.*;
import org.proyecto.multiplicacionmatrices.algoritmosinterfaces.*;
...
public class Algoritmos {
    ...
    public void v1_sequentialBlock(double[][]matrizA,double[][]matrizB,int size,int bsize){
    ...
    public void v1_parallelBlock(double[][]matrizA,double[][]matrizB,int size,int bsize){
    ...
    public void v2_sequentialBlock(double[][]matrizA,double[][]matrizB,int size,int bsize)
    {
    ...
    public void v2_parallelBlock (double[][]matrizA,double[][]matrizB,int size,int bsize)
    {
    ...
    public void v3_sequentialBlockTres(double[][]matrizA,double[][]matrizB,int size,int bsize)
    {
